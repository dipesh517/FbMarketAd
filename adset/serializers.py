...
class AdsetTargetingByGeoLocationSerializer(serializers.Serializer):
  latitude = serializers.DecimalField(max_digits=32, decimal_places=25, required = True)
  longitude = serializers.DecimalField(max_digits=32, decimal_places=25, required = True)
  radius = serializers.DecimalField(max_digits=32, decimal_places=25, required = True)
